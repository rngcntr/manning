...
public class DetailedGame {
    ...
    public String getStatsBox () {
        ...
        String guestYardsBar = Printer.generateBar(Math.round((double) Math.min(guest.getNaturalYards(), guest.getNaturalYards()) / maximum * 15.0),
                15, Printer.ANSI_BACK_WHITE, generateDefaultModifiers(), false);
        String guestPassBar = Printer.generateBar(Math.round((double) Math.min(guest.getNaturalYards(), guest.getNaturalPassYards()) / maximum * 15.0),
                15, Printer.ANSI_BACK_WHITE, generateDefaultModifiers(), false);
        String guestRushBar = Printer.generateBar(Math.round((double) Math.min(guest.getNaturalYards(), guest.getNaturalRushYards()) / maximum * 15.0),
                15, Printer.ANSI_BACK_WHITE, generateDefaultModifiers(), false);

        String homeYardsBar = Printer.generateBar(Math.round((double) Math.min(home.getNaturalYards(), home.getNaturalYards()) / maximum * 15.0),
                15, Printer.ANSI_BACK_WHITE, generateDefaultModifiers(), true);
        String homePassBar = Printer.generateBar(Math.round((double) Math.min(home.getNaturalYards(), home.getNaturalPassYards()) / maximum * 15.0),
                15, Printer.ANSI_BACK_WHITE, generateDefaultModifiers(), true);
        String homeRushBar = Printer.generateBar(Math.round((double) Math.min(home.getNaturalYards(), home.getNaturalRushYards()) / maximum * 15.0),
                15, Printer.ANSI_BACK_WHITE, generateDefaultModifiers(), true);
